...
class block_people extends block_base {
	...
	function get_content() {
		...
		if (!empty($CFG->coursecontact)) {
			...
			$teachers = get_role_users($teacherroles, $currentcontext, true, 'u.id, u.lastname, u.firstname, u.picture, u.imagealt, r.id AS role, r.sortorder', 'r.sortorder, u.lastname, u.firstname ASC');
		}
